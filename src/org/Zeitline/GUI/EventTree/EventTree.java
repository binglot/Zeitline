...
import org.Zeitline.GUI.Graphics.ColorTemplate;
...
public class EventTree extends JTree implements TreeSelectionListener {
    ...
    private static IEventTreeColorTemplate colorTemplate = new ColorTemplate();
    private static IIconRepository<ImageIcon> icons = new IconRepository();
    ...
    public EventTree(ComplexEvent root) {
      ...
      */
        ...
        setCellRenderer(new EventTreeCellRenderer(colorTemplate, icons));
